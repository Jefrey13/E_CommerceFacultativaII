...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"5966376e-9f3e-44ee-9b46-6975b0e94300\00", align 16
...
@__DSOCacheEntry_name.5 = internal constant [30 x i8] c"libcardioRecognizer_tegra2.so\00", align 16
@__DSOCacheEntry_name.6 = internal constant [23 x i8] c"libcardioRecognizer.so\00", align 16
...
@__DSOCacheEntry_name.9 = internal constant [18 x i8] c"libopencv_core.so\00", align 16
@__DSOCacheEntry_name.10 = internal constant [20 x i8] c"libcardioDecider.so\00", align 16
@__DSOCacheEntry_name.11 = internal constant [16 x i8] c"libmonodroid.so\00", align 16
@__DSOCacheEntry_name.12 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 16
@__DSOCacheEntry_name.13 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 16
@__DSOCacheEntry_name.14 = internal constant [21 x i8] c"libopencv_imgproc.so\00", align 16
...
@dso_cache = local_unnamed_addr global [56 x %struct.DSOCacheEntry] [
	...
	; 4
	%struct.DSOCacheEntry {
		i64 2707659342601065907, ; hash 0x259389d3888115b3, from name: cardioRecognizer_tegra2
		i8 0, ; ignore
	...
	; 5
	%struct.DSOCacheEntry {
		i64 2881673637240324206, ; hash 0x27fdc2e7c251406e, from name: libcardioRecognizer.so
		i8 0, ; ignore
	...
	; 7
	%struct.DSOCacheEntry {
		i64 3234834698184026030, ; hash 0x2ce47104e45de7ae, from name: cardioRecognizer.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 9
	%struct.DSOCacheEntry {
		i64 3479006673745455712, ; hash 0x3047ea231fcfaa60, from name: libopencv_core
		i8 0, ; ignore
	...
	; 12
	%struct.DSOCacheEntry {
		i64 4382557950844346246, ; hash 0x3cd1f93c8ba41f86, from name: libcardioDecider
		i8 0, ; ignore
	...
	; 14
	%struct.DSOCacheEntry {
		i64 5115548383145787273, ; hash 0x46fe1426b0ba7f89, from name: cardioDecider.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 15
	%struct.DSOCacheEntry {
		i64 5555509775882022630, ; hash 0x4d1922b4f1a86ee6, from name: cardioRecognizer
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 16
	%struct.DSOCacheEntry {
		i64 6255245558688120264, ; hash 0x56cf18b1a471fdc8, from name: cardioDecider
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 22
	%struct.DSOCacheEntry {
	...
	; 25
	%struct.DSOCacheEntry {
		i64 8322919210536890888, ; hash 0x7380f2ecde537208, from name: libopencv_imgproc
		i8 0, ; ignore
	...
	; 30
	%struct.DSOCacheEntry {
		i64 9285251197404261299, ; hash 0x80dbd6c4c78d2bb3, from name: libopencv_core.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 32
	%struct.DSOCacheEntry {
		i64 9409099383041328254, ; hash 0x8293d6098e86847e, from name: libcardioRecognizer_tegra2.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 33
	%struct.DSOCacheEntry {
		i64 9429023929821036284, ; hash 0x82da9f4e9ba3fefc, from name: opencv_imgproc
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.14, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 36
	%struct.DSOCacheEntry {
		i64 10546170829271826590, ; hash 0x925b867e4355809e, from name: libcardioRecognizer
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 38
	%struct.DSOCacheEntry {
		i64 11880367750141246082, ; hash 0xa4df8b861c2cfa82, from name: cardioRecognizer_tegra2.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 39
	%struct.DSOCacheEntry {
		i64 11910042569132537450, ; hash 0xa548f89d50ecf66a, from name: libcardioDecider.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 40
	%struct.DSOCacheEntry {
		i64 12779760268541186141, ; hash 0xb15ad441110c505d, from name: opencv_core
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 43
	%struct.DSOCacheEntry {
		i64 13780923077974902898, ; hash 0xbf3fac8663ad4872, from name: opencv_core.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 45
	%struct.DSOCacheEntry {
		i64 14433994841192853585, ; hash 0xc84fd9d55f1ef051, from name: libopencv_imgproc.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.14, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 48
	%struct.DSOCacheEntry {
		i64 15948437988910485507, ; hash 0xdd543bda3b5ad003, from name: libcardioRecognizer_tegra2
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 53
	%struct.DSOCacheEntry {
		i64 17817138085609933697, ; hash 0xf74330b08add0b81, from name: opencv_imgproc.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.14, i32 0, i32 0), ; name
		i8* null; handle
	}, 
